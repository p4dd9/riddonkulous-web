	...
	return (
		<div className="w-full max-w-2xl flex flex-col gap-6">
			...
			<p className="text-gray-300 text-center mb-6">
				...
				awesome Asset Packs or contributed majorly to the community and development. Everyone of those I have
				worked with was fun and professional. Please checkout their work.
			</p>
